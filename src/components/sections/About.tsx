    ...
    <section id="about" className="section" data-section="">
      ...
      <h2 className="section-title reveal">
        <span className="grad-text">
          {site?.aboutTitle || (
            <>
              Engineering <span className="accent">full-stack</span>
              <br />
              products that scale.
            </>
          )}
      ...
      <div className="about" style={{ marginTop: 64 }}>
        <div className="about-intro reveal delay-1">
          <p>
            {site?.bio1 || (
              <>
                I&apos;m a <strong>full-stack developer</strong> with 6+ years of experience
                shipping production-grade applications across web, mobile, and cloud.
              </>
            )}
          </p>
          <p>
            {site?.bio2 || (
              <>
                ...
                <strong>MongoDB</strong>, to <strong>React Native</strong> and{' '}
                <strong>Flutter</strong> apps published on Play Store and App Store.
              </>
            )}
          </p>
          <p>
          ...
          <p>
            {site?.bio4 ||
              'I approach every project with a product mindset — one engineer, every layer, from an empty repo to a live deployment.'}
          </p>
        </div>
