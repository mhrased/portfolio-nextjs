...
export default function DashboardPage() {
  ...
  const quickLinks = [
    ...
    { href: '/admin/projects', label: 'Manage Projects', desc: `${projects.length} projects · add, edit, reorder` },
    { href: '/admin/skills', label: 'Manage Skills', desc: `${skills.length} skills · update proficiency` },
    { href: '/admin/experience', label: 'Timeline', desc: `${experience.length} entries · career history` },
  ...
  return (
    <>
      ...
      <PageHeader
        title="Dashboard"
        desc={`Welcome back. Managing portfolio for ${site.name}.`}
      />

      <StatCards stats={stats} />

      <h2 style={{ fontSize: 15, fontWeight: 600, color: '#8892a4', letterSpacing: '0.06em', textTransform: 'uppercase', marginBottom: 16 }}>Quick Access</h2>
